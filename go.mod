...
require (
	...
	sigs.k8s.io/cluster-api-bootstrap-provider-kubeadm v0.0.0-20190822134432-e10c244919aa
	sigs.k8s.io/cluster-api-provider-docker v0.1.1-0.20190822174033-bc6d722b98e9
